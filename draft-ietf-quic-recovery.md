...
declare all packets as lost immediately upon sending them.  To avoid declaring
packets as lost too early, the time threshold MUST be set to at least
kGranularity (defined in {{ld-consts-of-interest}}).
