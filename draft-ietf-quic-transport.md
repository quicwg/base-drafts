...
in response to packets which only contain ACK frames. However, they SHOULD ACK
packets containing only ack frames when sending ACK frames in response to other
packets.
