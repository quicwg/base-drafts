...
The first Client Initial packet that is sent by a client contains
packet number 0.  All subsequent packets contain a packet number that
is incremented by one, see ({{packet-numbers}}).
...
The first Server Cleartext packet contains packet number 0.  This
