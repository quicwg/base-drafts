...
specific condition.  For example, a FLOW_CONTROL_ERROR might be used to indicate
that exceeding flow control limits caused the error.  A client that has a
connection closed due to an error condition SHOULD NOT attempt 0-RTT when
